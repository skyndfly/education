            ...
            <div class="col-3">
                <nav>
                    <ul id="menu" class="list-group">
                        ...
                        <li class="list-group-item"><a href="#">Random</a></li>
                        <li class="list-group-item"><a href="#">Empty</a></li>
                        <li class="list-group-item"><a href="#">Also Empty</a></li>
...
<footer id="footer" class="mt-auto py-3 bg-light">
    <div class="container">
        <div class="row text-muted">
            <div class="col-md-6 text-center text-md-start">&copy; EducationCRM <?= date('Y') ?></div>
